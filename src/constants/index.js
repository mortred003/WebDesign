...
export const servicesData = [
  ...
  {
    title: "Media Design",
    description: "Help with your costumer reach",
    items: [
      {
...
export const projects = [
  {
    id: 1,
    name: "Cake Shop E-Comerce",
    description:
      "An online store specializing in ordering costumized desserts and Cakes for any type of occasion",
    href: "",
